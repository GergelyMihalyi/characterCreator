create table characters(id bigint auto_increment, name varchar(60) not null, age int, base_attack_damage int, base_health_point int, actual_health_point int not null, weapon_id bigint,level int not null default 1,race_id bigint, class_id bigint,primary key(id));
...
insert into characters(name,age,base_attack_damage,base_health_point,actual_health_point) values ('John Doe',31,13,110,110);
insert into characters(name,age,base_attack_damage,base_health_point,actual_health_point) values ('Jack Doe',31,13,100,100);
