...
create table characters(id bigint auto_increment, name varchar(60) not null, age int, base_attack_damage int, base_health_point int, actual_health_point int not null, weapon_id bigint,experience int not null,level int not null, primary key(id));
...
ALTER TABLE character_race
    ADD CONSTRAINT CHARACTER_RACE_RACE
